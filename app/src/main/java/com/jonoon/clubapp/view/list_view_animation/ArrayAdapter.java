 ...
 */
package com.jonoon.clubapp.view.list_view_animation;
...
import com.jonoon.clubapp.view.list_view_animation.view.DynamicListView;
import com.jonoon.clubapp.view.list_view_animation.view.DynamicListView.Swappable;

/**
 * A true {@link java.util.ArrayList} adapter providing access to all ArrayList methods.
...
public abstract class ArrayAdapter<T> extends BaseAdapter implements DynamicListView.Swappable {
	...
	/**
	 * Creates a new {@link com.jonoon.clubapp.view.list_view_animation.ArrayAdapter} with a <b>copy</b> of the specified
