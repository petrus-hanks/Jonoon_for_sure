package com.jonoon.clubapp.view.list_view_animation.itemmanipulation;
...
import com.jonoon.clubapp.view.list_view_animation.ArrayAdapter;
...
public abstract class ExpandableListItemAdapter<T> extends ArrayAdapter<T> {
	...
	/**
	 * Creates a new {@link com.jonoon.clubapp.view.list_view_animation.itemmanipulation.ExpandableListItemAdapter} with the specified list,
	...
	/**
	 * Set the resource id of the child {@link android.view.View} contained in the View returned by
	 * {@link #getTitleView(int, android.view.View, android.view.ViewGroup)} that will be the actuator of the expand / collapse animations.<br>
