 ...
 */
package com.jonoon.clubapp.view.list_view_animation.itemmanipulation.contextualundo;
...
import com.jonoon.clubapp.view.list_view_animation.BaseAdapterDecorator;
 ...
 * <p>
 * Usage: <br>
 * * Create a new instance of this class providing the {@link android.widget.BaseAdapter} to wrap, the undo layout, and the undo button id, optionally a delay time millis, a count down TextView res id, and a delay in milliseconds before deleting the item .<br>
 * * Call {@link #setDeleteItemCallback(com.jonoon.clubapp.view.list_view_animation.itemmanipulation.contextualundo.ContextualUndoAdapter.DeleteItemCallback)} to be notified of when items should be removed from your collection.<br>
...
public class ContextualUndoAdapter extends BaseAdapterDecorator implements ContextualUndoListViewTouchListener.Callback {
	 ...
	 * @param countDownFormatter the {@link com.jonoon.clubapp.view.list_view_animation.itemmanipulation.contextualundo.ContextualUndoAdapter.CountDownFormatter} which provides text to be shown in the {@link android.widget.TextView} as specified by countDownTextViewResId
	 */
